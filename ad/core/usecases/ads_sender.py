...
from ad.core.entities import View, DetailedAd
...
class AdsSenderUseCase:
    ...
    def execute(self, tag: Optional[str]) -> None:
        ...
        ads_d: Dict[str, DetailedAd] = {ad.id: ad for ad in ads}
        unsent_ads: List[DetailedAd] = [ads_d[unsent_ads_id] for unsent_ads_id in unsent_ads_ids]
